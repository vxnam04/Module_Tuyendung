...
class ScheduleNotificationRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'scheduled_at.required' => 'Thời gian lên lịch là bắt buộc',
            'scheduled_at.date' => 'Thời gian lên lịch phải là định dạng ngày tháng',
            'scheduled_at.after' => 'Thời gian lên lịch phải sau thời gian hiện tại',
